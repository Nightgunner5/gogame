...
var baseLayout = map[Coord]MultiTile{
	...
	Coord{0, 15}:  {Window},
	Coord{1, -4}:  {Wall1},
	Coord{1, -3}:  {TileWhite, TileGrayNE, TileGrayNW, Light1NOn},
	Coord{1, -2}:  {TileWhite},
	Coord{1, -1}:  {TileWhite},
	Coord{1, 0}:   {TileWhite},
	Coord{1, 1}:   {TileWhite},
	Coord{1, 2}:   {TileWhite},
	Coord{1, 3}:   {TileWhite, TileGraySW, TileGraySE, Light1SOn},
	Coord{1, 4}:   {Wall1},
	Coord{1, 7}:   {Window},
	...
	Coord{3, 15}:  {Window},
	Coord{4, -4}:  {Wall1},
	Coord{4, -3}:  {TileWhite, TileGrayNE, TileGrayNW, Light1NOn},
	Coord{4, -2}:  {TileWhite},
	Coord{4, -1}:  {TileWhite},
	Coord{4, 0}:   {TileWhite},
	Coord{4, 1}:   {TileWhite},
	Coord{4, 2}:   {TileWhite},
	Coord{4, 3}:   {TileWhite, TileGraySE, TileGraySW, Light1SOn},
	Coord{4, 4}:   {Wall1},
	Coord{4, 5}:   {Window},
	Coord{4, 6}:   {Window},
	Coord{4, 7}:   {Wall1},
	...
	Coord{9, 19}:  {TileWhite, TileGraySW},
	Coord{9, 20}:  {TileGray},
	Coord{9, 21}:  {Wall1},
	Coord{9, 22}:  {Wall1},
	Coord{10, 7}:  {Wall1},
	...
	Coord{11, 17}: {TileWhite, TileGrayNE},
	...
	Coord{12, 16}: {TileGray, TileBlackSE, TileBlackNE, Wall1NE},
	Coord{12, 17}: {TileGray, TileBlackNE},
	...
	Coord{13, 11}: {TileRed, TileBlackNE},
	...
	Coord{13, 22}: {Wall1},
	Coord{14, 8}:  {Wall1},
	Coord{14, 9}:  {TileRed, Computer},
	Coord{14, 10}: {TileBlack, TileRedNE},
	...
	Coord{17, 23}: {Wall1NE},
	Coord{18, 9}:  {Wall1},
	Coord{18, 10}: {TileBlack, Computer},
	Coord{18, 11}: {TileBlack},
	...
	Coord{19, 9}:  {Wall1SW},
	Coord{19, 10}: {Wall1},
	Coord{19, 11}: {TileBlack},
	Coord{19, 12}: {TileBlack, DoorSecurityClosed},
	...
	Coord{20, 19}: {TileWhite, TileCyanSE, TileCyanNW, Light1SOn},
	...
	Coord{21, 19}: {TileWhite, TileCyanSE, TileCyanNW},
