...
var baseLayout = map[Coord]MultiTile{
	...
	Coord{1, 12}:  {WireW, WireN, WireS, TileGray, Light1WOn},
	...
	Coord{2, 6}:   {Window},
	Coord{2, 7}:   {Wall1},
	Coord{2, 8}:   {WireN, WireE, TileGray, Light1NOn},
	...
	Coord{3, 5}:   {TileBlack},
	Coord{3, 6}:   {TileBlack},
	Coord{3, 7}:   {WireS, TileBlack, DoorGeneralClosed},
	...
	Coord{4, 6}:   {Window},
	Coord{4, 7}:   {Wall1},
	Coord{4, 8}:   {WireN, WireW, TileGray, Light1NOn},
	Coord{4, 9}:   {TileGray},
	Coord{4, 10}:  {TileGray},
	Coord{4, 11}:  {TileGray},
	Coord{4, 12}:  {TileGray},
