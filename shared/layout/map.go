...
var baseLayout = map[Coord]MultiTile{
	...
	Coord{0, 4}:   {Wall1},
	Coord{0, 7}:   {Window},
	Coord{0, 8}:   {TileRellow, TileGraySE},
	Coord{0, 9}:   {TileRellow, TileGraySE, TileGrayNE},
	Coord{0, 10}:  {TileRellow, TileGraySE, TileGrayNE, Wall1SW},
	...
	Coord{3, 5}:   {TileBlack, TriggerSelectRole},
	Coord{3, 6}:   {TileBlack},
	...
	Coord{5, 4}:   {Wall1},
	Coord{5, 7}:   {Window},
	Coord{5, 8}:   {TileRellow, TileGraySE, TileGraySW},
	Coord{5, 9}:   {TileGray},
	Coord{5, 10}:  {TileGray},
	Coord{5, 11}:  {TileGray},
	Coord{5, 12}:  {TileGray},
	...
	Coord{6, 4}:   {Wall1NW},
	Coord{6, 7}:   {Window},
	Coord{6, 8}:   {TileRellow, TileGraySE, TileGraySW},
	Coord{6, 9}:   {TileGray},
	Coord{6, 10}:  {TileGray},
	Coord{6, 11}:  {TileGray, TileRellowSE},
	Coord{6, 12}:  {TileRellow, TileGrayNW, TileGraySW},
	Coord{6, 13}:  {TileRellow, TileGrayNW, TileGraySW},
	Coord{6, 14}:  {TileRellow, TileGrayNW, TileGraySW, Light1EOn},
	Coord{6, 15}:  {Wall1},
	Coord{6, 16}:  {Wall1NE},
	Coord{7, -3}:  {Wall1SW},
	Coord{7, -2}:  {Wall1},
	...
	Coord{7, 3}:   {Wall1NW},
	Coord{7, 7}:   {Wall1},
	Coord{7, 8}:   {TileRellow, TileGraySE, TileGraySW, Wall1NE},
	Coord{7, 9}:   {TileGray},
	Coord{7, 10}:  {TileGray},
	...
	Coord{8, 12}:  {TileGray, TileWhiteSE, Wall1NW},
	...
	Coord{9, 12}:  {TileWhite, TileGrayNW, TileGrayNE},
	...
	Coord{10, 12}: {TileWhite, TileGrayNW, TileGrayNE},
	...
	Coord{11, 14}: {TileWhite, TileGrayNE, TileGraySE, Light1EOn},
