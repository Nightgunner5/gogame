...
var baseLayout = map[Coord]MultiTile{
	...
	Coord{1, 9}:   {WireS, WireE, TileGray},
	Coord{1, 10}:  {WireN, WireS, TileGray},
	Coord{1, 11}:  {WireN, WireS, TileGray},
	Coord{1, 12}:  {WireN, WireS, TileGray, Light1WOn},
	Coord{1, 13}:  {WireN, WireS, TileGray},
	Coord{1, 14}:  {WireE, WireN, TileGray},
	Coord{1, 15}:  {Window},
	Coord{2, -4}:  {Wall1},
	...
	Coord{2, 9}:   {WireW, WireE, TileGray},
	Coord{2, 10}:  {TileGray},
	Coord{2, 11}:  {TileGray},
	Coord{2, 12}:  {TileGray},
	Coord{2, 13}:  {TileGray},
	Coord{2, 14}:  {WireE, WireW, TileGray},
	Coord{2, 15}:  {Window},
	Coord{3, -4}:  {Wall1},
	...
	Coord{3, 8}:   {WireS, WireN, WireE, WireW, TileGray},
	Coord{3, 9}:   {WireW, WireN, TileGray},
	Coord{3, 10}:  {TileGray},
	Coord{3, 11}:  {TileGray},
	Coord{3, 12}:  {TileGray},
	Coord{3, 13}:  {TileGray},
	Coord{3, 14}:  {WireE, WireW, TileGray},
	Coord{3, 15}:  {Window},
	Coord{4, -4}:  {Wall1},
	...
	Coord{4, 12}:  {TileGray},
	Coord{4, 13}:  {TileGray},
	Coord{4, 14}:  {WireE, WireW, TileGray},
	Coord{4, 15}:  {Window},
	Coord{5, -4}:  {Wall1},
	...
	Coord{5, 12}:  {TileGray},
	Coord{5, 13}:  {TileGray},
	Coord{5, 14}:  {WireE, WireW, TileGray},
	Coord{5, 15}:  {Window},
	Coord{6, -4}:  {Wall1SW},
	Coord{6, -3}:  {Wall1},
	...
	Coord{6, 14}:  {WireE, WireW, TileGray, TileRellowSE, TileRellowNE},
	Coord{6, 15}:  {Wall1},
	Coord{6, 16}:  {Wall1NE},
	Coord{7, -3}:  {Wall1SW},
	Coord{7, -2}:  {Wall1},
	...
	Coord{7, 12}:  {WireS, WireW, TileRellow, Wall1},
	Coord{7, 13}:  {WireS, WireN, TileRellow, DoorGeneralClosed},
	Coord{7, 14}:  {WireN, WireW, WireS, TileRellow, Wall1},
	Coord{7, 15}:  {WireN, WireS, Wall1},
	Coord{7, 16}:  {WireN, WireS, Wall1},
	Coord{7, 17}:  {WireN, WireS, Wall1},
	Coord{7, 18}:  {WireE, WireS, WireN, Wall1},
	Coord{7, 19}:  {WireN, WireS, Wall1},
	Coord{7, 20}:  {WireN, WireS, Wall1},
	Coord{7, 21}:  {WireN, WireS, Wall1},
	Coord{7, 22}:  {WireE, WireN, Wall1},
	Coord{7, 23}:  {Wall1},
	Coord{7, 24}:  {Wall1},
	Coord{7, 25}:  {Wall1},
	Coord{8, 7}:   {Wall1},
	...
	Coord{8, 21}:  {Wall1},
	Coord{8, 22}:  {WireE, WireW, WireS, TileGray, Generator},
	Coord{8, 23}:  {WireN, TileGray, Generator},
	Coord{8, 24}:  {TileWhite},
	Coord{8, 25}:  {Wall1},
	Coord{9, 7}:   {Wall1},
	...
	Coord{9, 21}:  {Wall1},
	Coord{9, 22}:  {WireE, WireW, WireS, TileGray, Generator},
	Coord{9, 23}:  {WireN, TileGray, Generator},
	Coord{9, 24}:  {TileWhite},
	Coord{9, 25}:  {Wall1},
	Coord{10, 7}:  {Wall1},
	Coord{10, 8}:  {WireE, TileRed, Computer},
	...
	Coord{11, 9}:  {WireS, WireN, TileBlack, Light1EOn},
	...
	Coord{12, 14}: {WireW, TileBlack, Wall1},
	...
	Coord{13, 21}: {Wall1},
	Coord{13, 22}: {WireW, WireE, TileWhite},
	Coord{13, 23}: {TileWhite},
	Coord{13, 24}: {TileWhite},
	Coord{13, 25}: {Wall1},
	Coord{14, 8}:  {Wall1},
	Coord{14, 9}:  {WireW, WireE, WireS, TileBlack, Generator},
	...
	Coord{14, 17}: {WireN, WireE, WireW, TileBlack},
	Coord{14, 18}: {TileWhite},
	Coord{14, 19}: {TileWhite},
	Coord{14, 20}: {WireE, WireW, WireS, TileRellow},
	Coord{14, 21}: {WireN, WireS, TileRellow, DoorEngineerClosed},
	...
	Coord{22, 15}: {WireE, WireW, TileWhite, DoorMedicalClosed},
	...
	Coord{23, 23}: {Wall1},
	Coord{24, 13}: {Wall1},
	Coord{24, 14}: {WireW, TileWhite, Light1NOn},
	...
	Coord{24, 22}: {WireW, TileWhite, Light1SOn},
	Coord{24, 23}: {Wall1},
	Coord{25, 13}: {Wall1},
